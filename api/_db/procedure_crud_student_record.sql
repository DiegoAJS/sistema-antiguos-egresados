 ...
 CASE _operation 
   ...
   /* LOGIN ESTUDIANTES */
    ...
    IF EXISTS(select b.career from table_person a INNER JOIN table_student_record b on a.person_id = b.person_student_id WHERE a.ci=_person_student_id AND b.cu=_cu AND b.deleted IS NULL) THEN
		select b.career from table_person a INNER JOIN table_student_record b on a.person_id = b.person_student_id WHERE a.ci=_person_student_id AND b.cu=_cu AND b.deleted IS NULL;
    END IF;
...
/* Lista * /
call crud_table_student_record(6,null, null, null, null, null, null, null, null,null);
